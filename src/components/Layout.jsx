  ...
  return user ? (
    ...
    <section className='w-full min-h-screen flex'>
      ...
      </div>
      {
        ...
        : (<i className="ri-menu-2-line z-99999 absolute top-3 right-3 p-2 bg-white rounded-md shadow w-10 h-10 text-gray-600 sm:hidden" onClick={()=>setSideBarOpen(true)}></i>)
      }
