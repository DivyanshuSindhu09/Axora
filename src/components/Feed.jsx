...
const Feed = () => {
  ...
  return feeds.length > 0 ? (
    <section className="max-h-screen text-white overflow-x-hidden overflow-y-scroll no-scrollbar flex flex-col lg:flex-row items-start justify-center lg:gap-8 bg-[#0f172a]">

      {/* Stories + Post list */}
      <div className="min-h-screen w-full lg:w-[70%] space-y-4">
